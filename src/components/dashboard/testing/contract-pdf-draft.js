export default {
  header:
    '<h1>ENTENTE DE PARTAGE DE DROITS</h1><p><i>Droit d’auteur sur l’oeuvre & Droits voisins des artistes-interprètes et <b>producteurs</b></i></p>',
  sections: {
    generalInformations:
