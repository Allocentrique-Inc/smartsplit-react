export default {
  ...
  sections: {
    ...
    recommendations:
      '<h2>Prochaines étapes recommandées</h2><p>Cette entente se limite à la définition du partage de droits entre les contributeurs et quelques aspects connexes. Sans s’y limiter, les contributeurs sont par ailleurs responsables de :</p><nol type="number"><li>définir entre eux toute autre modalité relative à l’exploitation de l’oeuvre et au partage des revenus (incluant le paiement de toute avance);</li><li>procéder à la déclaration des partages de droits sur l’oeuvre, la prestation et l’enregistrement sonore de la pièce musicale aux Sociétés de gestion de collective droits pertinentes (comme la SOCAN, la SOPROQ, ARTISTI au Canada);</li><li>s’assurer de respecter toute entente collective applicable ou toute obligation découlant d’une loi relative au statut des artistes; et honorer ses propres ententes préalablement signées avec des tiers  (p. ex. éditeurs, administrateur d’éditions, co-éditeurs, sous-éditeurs).</li><li>Petite description sympa,<nol><li>définir entre eux toute autre modalité relative à l’exploitation de l’oeuvre et au partage des revenus (incluant le paiement de toute avance);</li><li>procéder à la déclaration des partages de droits sur l’oeuvre, la prestation et l’enregistrement sonore de la pièce musicale aux Sociétés de gestion de collective droits pertinentes (comme la SOCAN, la SOPROQ, ARTISTI au Canada);</li><li>s’assurer de respecter toute entente collective applicable ou toute obligation découlant d’une loi relative au statut des artistes; et honorer ses propres ententes préalablement signées avec des tiers  (p. ex. éditeurs, administrateur d’éditions, co-éditeurs, sous-éditeurs).</li></nol></li></nol>',
    moralRights:
    ...
    signatures: {
      text:
        'En foi de quoi les parties ont signé à Montréal, Province de Québec, ce 18 juillet 2020.',
