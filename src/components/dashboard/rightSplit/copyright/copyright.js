...
const Copyright = (props) => { 
  ...
  const deleteCollaborator = (rightHolder) => {
    ...
    arr.splice(props.copyright.find((el1) => el1.user_id === rightHolder), 1)
    const calculatedCopyright = recalculateShares({
      newDividingMethod: dividingMethod,
      copyright: arr
    })
  ...
  const commonProps = {
    workpiece_id,
    dividingMethod, selectDividingMethod,
    addCollaborators,
    deleteCollaborator,
    deleteRole,
    addRole,
          ...
          <div style={style.b1b1b1}>
            ...
            {props.copyright.map((el, id) => {  
              ...
              const collaborator = typeof el.rightHolder === 'string' 
                ...
                : el.rightHolder  
              return ( <Collaborator key={collaborator.user_id} {...props} {...commonProps} el={el} id={id} collaborator={collaborator} /> )
            })}
