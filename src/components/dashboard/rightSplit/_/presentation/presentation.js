    ...
    <>
      ...
      <div style={style.text1}>
        {(() => {
          switch (props.view) {
            case "copyright":
              return "Qui a inventé cette pièce musicale?";
            case "performance":
              return "Qui a joué sur l'enregistrement sonore?";
            case "recording":
              return "Qui possède l'enregistrement sonore?";
            case "privacy":
              return "Veux tu rendre ce partage public?";
            default:
              return "ERROR";
          }
        })()}
      ...
      <div style={style.text2}>
        {(() => {
          switch (props.view) {
            case "copyright":
              return `Sépare ici le droit d'auteur entre les créateurs, c'est-à-dire, les
            ...
            case "performance":
              return `On sépare ici le droit voisin entre les interprètes, autant les 
            ...
            case "recording":
              return `On sépare ici le droit voisin des producteurs, c'est à dire ceux 
              ...
              de l'investissement.`;
            case "privacy":
              return "Expliquez ou est-ce que ca va se retrouver et que ca va etre soumis au vote.";
            default:
              return "ERROR";
          }
        })()}
