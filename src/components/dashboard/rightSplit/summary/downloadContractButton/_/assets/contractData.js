  ...
  sections: {
    ...
    rightSplit: {
      ...
      copyright: [
        {
          rightHolder: {
            user_id: 'fd8c3947-5e2b-4200-8f4f-1b738cb6acc6',
            artistName: "L'artiste",
            firstName: 'FRANCOIS-X',
            lastName: 'DUEYMES',
            locale: 'fr',
            isni: 'asdfasdfasdfdfsdaf',
            organisations: [],
            projects: [],
            emails: ['fx@iptoki.com'],
            pendingEmails: [],
          },
          roles: ['author'],
          shares: 25,
        ...
        {
          rightHolder: {
            user_id: '0d8f03c7-f1d8-4c1c-a984-0af19db04b0f',
            artistName: 'ARTIST 1',
            firstName: 'FX1',
            lastName: 'DUMS',
            locale: 'en',
        ...
        {
          rightHolder: {
            user_id: 'ba68e3ea-b6ad-4aa3-96d5-a7c0143fb6a4',
            artistName: 'ARTIST 2',
            firstName: 'FX2',
            lastName: 'DUDUMS',
            locale: 'en',
        ...
        {
          rightHolder: {
            user_id: 'e5e002a5-e7d8-4355-9dda-03d44fede714',
            artistName: 'ARTIST 3',
            firstName: 'FX3',
            lastName: 'DUDUDUMS',
            locale: 'en',
