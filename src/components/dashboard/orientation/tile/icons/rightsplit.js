...
function SvgComponent(props) {
  return (
    ...
    >
      ...
      />
      <path
        d="M26.429 49.945c.519.036 1.043.055 1.571.055 12.15 0 22-9.85 22-22 0-.796-.042-1.583-.125-2.357M12.68 43.788A21.935 21.935 0 016 28c0-3.687.907-7.162 2.51-10.214M18.57 8.117A21.915 21.915 0 0128 6c5.79 0 11.057 2.237 14.986 5.893M28 6v12.571M18.572 28H6.001M50 28H37.429"
        stroke="#DCDFE1"
        strokeWidth={2}
        strokeLinecap="round"
        strokeLinejoin="round"
