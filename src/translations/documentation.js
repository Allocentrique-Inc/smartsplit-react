export default {
  topBar: {
    breadCrumb: {
      _documentation: { fr: 'Documenter mon oeuvre', en: 'Document my work ' },
      _creation: { fr: 'Création', en: 'Creation' },
      _performance: { fr: 'Interprétation', en: 'Performance' },
      _recording: { fr: 'Enregistrement', en: 'Recording' },
      _release: { fr: 'Sortie', en: 'Release' },
      _files: { fr: 'Fichiers', en: 'Files' },
      _info: { fr: 'Informations générales', en: 'General information' },
      _lyrics: { fr: 'Paroles', en: 'Lyrics' },
      _streaming: { fr: "Liens d'écoute", en: 'Streaming links' },
    },
