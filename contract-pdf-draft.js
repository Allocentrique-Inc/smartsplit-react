export default {
  ...
  sections: {
    generalInformations: '<h2>Entente concernant la pièce musicale originale :</h2><p><strong>Monsieur Poirier (feat. Claude Poirier)</strong> interprétée par <i>Luminol</i>, ci-après la <b>«pièce»</b> musicale.</p>',
    rightHolders: {
    ...
    rightSplits: {
      title:
       ...
       copyright: [
          {
            avatar: '?',
            name: 'Frédéric Desjardins (Luminol)',
            roles: 'Auteur, Arrangeur, Compositeur',
            share: 75,
          },
        ],
        performance: [],
